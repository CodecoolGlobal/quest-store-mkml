...
public class StudentArtifactStore implements HttpHandler {
    ...
    private String getRenderedPage(User user) throws DaoException {
        ...
        JtwigTemplate template = JtwigTemplate.classpathTemplate("/templates/student/student_artifact_store.twig");
